...
function MapComponent() {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      {showSearchUI && <div className="absolute z-[1000] top-3 left-1/2 -translate-x-1/2 w-[94%] max-w-2xl bg-white/95 backdrop-blur rounded-2xl shadow-[0_18px_40px_rgba(2,12,27,0.16)] p-3 space-y-3 border border-slate-100" dir="rtl">
